@extends('layouts.app', ['page' => __('On-Project Request'), 'pageSlug' => 'onproject-request'])

@section('content')
<div class="container">
    <div class="col-md-11">
        <div class="card">
            <div class="card-header">On Project</div>
            ...
            <div class="card-body">
                ...
                <button type="submit" class="btn btn-primary" data-toggle="modal" data-backdrop="static"
                    data-keyboard="false" data-target="#myModalHorizontal">Add on project</button>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-header" style="height:4em;background: orange">
                    <h4 class="modal-title" id="myModalLabel" style="color: whitesmoke;">on-project</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">close</button>

                </div> <!-- Modal Body -->
                <div class="modal-body" style="background-color: burlywood;">
                    <form method="POST" action="{{route('onproject.save')}}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input name="remark" class="date form-control" type="text">
                            </div>
                        </div>
