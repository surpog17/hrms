@extends('layouts.app', ['page' => __('Leave Request'), 'pageSlug' => 'leave-request'])
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <button type="submit" class="btn btn-primary" data-toggle="modal" data-backdrop="static"
                    data-keyboard="false" data-target="#myModalHorizontal">Add Sick Leave</button>
                ...
                <table class="table" style="margin-top: 5em;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$s->from}} - {{$s->to}}</td>
                            <td><a href="{{route('leave.download',$s->id)}}" class="btn btn-info btn-sm">Download</a>
                            </td>
                            <td>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-header" style="height:4em;background: orange">
                    <h4 class="modal-title" id="myModalLabel" style="color: whitesmoke;">Add Sick Leave</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">close</button>

                </div> <!-- Modal Body -->
                <div class="modal-body" style="background-color: burlywood;">
                    <form method="POST" action="{{route('leave.save')}}" enctype='multipart/form-data'>
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input name="from_date" class="date form-control" type="date">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="datetimepicker2" class="col-sm-2 col-form-label col-form-label-sm">To</label>
                            <div class="col-sm-8">
                                <input name="to_date" class="date form-control" type="date">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="attachment" class="col-sm-2 col-form-label col-form-label-sm">Attachment</label>
                            <div class="col-sm-8">
                                <input name="attachment" class="date form-control" type="file">
                            </div>
                        </div>
