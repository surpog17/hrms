@extends('layouts.app', ['page' => __('Warning Type'), 'pageSlug' => 'warning-type'])
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <button type="submit" class="btn btn-primary" data-toggle="modal" data-backdrop="static"
                    data-keyboard="false" data-target="#myModalHorizontal">Add Type</button>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-header" style="height:4em;background: #13c0d4">
                    <h4 class="modal-title" id="myModalLabel" style="color: whitesmoke;">Add Warning Type</h4>
