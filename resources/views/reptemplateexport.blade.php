    ...
    <div class="row justify-content-center">
        <div class="col-md-11">
            <ul style="float:right" class="nav nav-tabs">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{{route('reprimand.show')}}">Reprimand Export</a>
                </li>
            </ul>
            <div class="card">
                <div class="card-header">Reprimand Export</div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('reprimand.export')}}">
                        @csrf
