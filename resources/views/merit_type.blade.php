@extends('layouts.app', ['page' => __('Merit Type'), 'pageSlug' => 'merit-type'])
@section('styles')
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <button class="btn btn-success btn-link" data-toggle="modal" data-backdrop="static"
                                        data-keyboard="false" data-id="{{$type->id}}" data-name="{{$type->name}}"
                                        data-target="#editModalHorizontal">
                                        <i class="material-icons">edit</i>
                                                    <div class="ripple-container"></div>
                                    </button>
                                    <form method="POST" action="{{route('merit_type.delete',$type->id)}}">
                                    @csrf
                                        @method('delete')
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-header" style="height:4em;background: #13c0d4">
                    <h4 class="modal-title" id="myModalLabel" style="color: whitesmoke;">Add Merit Type</h4>
                ...
                <div class="modal-body" style="background-color: #fffff;">
                    <form method="POST" action="{{route('merit_type.store')}}">
                        @csrf
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control form-control-sm" id="name" type="text" style="color: black" name="type" value=""
                                    placeholder="Merit Type" required />
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body" style="background-color: #fffff;">
                    ...
                    <form method="POST" action="{{route('merit_type.update')}}">
                        @method('PUT')
                        @csrf
