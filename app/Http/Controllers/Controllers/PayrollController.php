...
class PayrollController extends Controller
{
    ...
    public function email()
    {
        ...
        //$payroll = Payroll::where('employee_id', '>', 600)->get();
        $payroll = Payroll::all();
            ...
            if ($webhr) {
                ...
                if ($webhr->email) {
                    ...
                    Mail::send(
                        'emails.payroll',
                        ['pass_data' => $data],
                        function ($message) use ($file, $webhr) {
                            $message->from(
                                'iefinance@ienetworksolutions.com',
                                'IEFinanceNoReply@ienetworksolutions.com'
                            );

                            $message
                                ->to($webhr->email)
                                ->cc('iefinance@ienetworksolutions.com')
                                 ->bcc('hawi@ienetworks.co')
